...
/**
 * the controller for the addProducts fxml
 */
public class AddProducts {
    ...
    /**
     * initializes the addProducts screen
     */
    public void initialize(){
         int ID = Inventory.getProductInventoryList().size() + 1;
    ...
    /**
     * removes all parts from the temporary inventory list and returns to the main screen
     ...
     * adds the product to the product inventory list
     ...
     * @param actionEvent activates when the save button is clicked
     * @throws IOException ioexception
     */
